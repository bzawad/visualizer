...
class MiniRacerVisualizer : public Visualizer
{
public:
    MiniRacerVisualizer();
    ~MiniRacerVisualizer();
...
private:
    ...
    // Colors - all monochrome green
    static constexpr float ROAD_COLOR[3] = {0.0f, 1.0f, 0.0f};     // Bright green
    static constexpr float BUILDING_COLOR[3] = {0.0f, 0.8f, 0.0f}; // Medium green
    static constexpr float GRID_COLOR[3] = {0.0f, 0.5f, 0.0f};     // Dark green
    ...
    static constexpr float SUN_INNER_COLOR[3] = {0.0f, 1.0f, 0.0f}; // Bright green
    static constexpr float SUN_OUTER_COLOR[3] = {0.0f, 0.7f, 0.0f}; // Medium green
